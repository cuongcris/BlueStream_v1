...
public class AdminFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (a == null) {
            String ms = "Please use admin account to access";
            req.setAttribute("ms", ms);

            req.getRequestDispatcher("Login.jsp").forward(request, response);
        } else if (a.getRole() == 1 || a.getRole() == 2) {
            String ms = "You are not Admin!";
            System.out.println(a.getRole());
            req.setAttribute("ms", ms);
            req.getRequestDispatcher("ErrorControl").forward(request, response);
        }
