...
<html>
    ...
    <body id="reportsPage">
        ...
        <div class="input-group mt-5 col-xl-12">
            ...
            <button type="button" class="btn btn-outline-primary" style="margin: 0px 191px 40px -85px">search</button>
            ...
            <div class="row tm-content-row">
                <div class="col-xl-12">
                    <div class="tm-bg-primary-dark tm-block tm-block-products">
                        ...
                        <!-- table container -->
                        <a href="AddAds.jsp" class="btn btn-primary btn-block text-uppercase mb-3">Add new ADS</a>
                    </div>
                </div>
            </div>
        </div>
